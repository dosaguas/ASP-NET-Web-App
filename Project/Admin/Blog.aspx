...
<fieldset id="InsertBlogEntryWrapper"> <!-- BEGIN SECOND FIELDSET-->
<legend>Post Blog Entry</legend>
<asp:Label ID="lblInsertTitle" runat="server" Text="Title" AssociatedControlID="txtInsertTextbox" />
<asp:TextBox ID="txtInsertTextbox" Text="" runat="server" />
<br />
  <!-- RICH EDITOR GOES HERE-->
 <cc1:Editor ID="txtContent"  runat="server" Width="75%" Height="300px" />
 <!-- /TinyMCE -->

        <asp:Button ID="SubmitBlogEntry" ClientIDMode="Static" Text="Submit Blog Entry" OnClientClick="" runat="server" OnClick="CreateBlogEntry" />

    <asp:Label ID="lbleditorMessage" runat="server" Text=""></asp:Label>

</fieldset><!-- END OF SECOND FIELDSET-->
</asp:Panel>
